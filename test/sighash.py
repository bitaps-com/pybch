...
class SighashTests(unittest.TestCase):
    ...
    def test_sighash_segwit(self):
        ...
        m = "010000000126abcfccf25ce89cca923972468babe0b5b8b39fef1b60794e78b75d6f47994f010000001976a9140c7619c92ef6e9260f64b5ccdf0e47b3004bdbdf88acffffffff011d37950a000000001976a9145ba86fdd83da8e94f743d21928331ec117724edc88ac00000000"

        tx = Transaction.deserialize(m)
        print(tx.json())
        h = double_sha256(tx.sighash1(SIGHASH_ALL, 0, unhexlify(b"76a9140c7619c92ef6e9260f64b5ccdf0e47b3004bdbdf88ac")) + int(SIGHASH_ALL).to_bytes(4, 'little'))
        r = hexlify(tx.sighash1(SIGHASH_ALL, 0, unhexlify(b"76a9140c7619c92ef6e9260f64b5ccdf0e47b3004bdbdf88ac")) + int(SIGHASH_ALL).to_bytes(4, 'little'))
        print(r)
        self.assertEqual(hexlify(h).decode(),
